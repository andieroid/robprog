...
class image_converter:
    ...
    def __init__(self):
        ...
        self.image_sub = rospy.Subscriber("/thorvald_001/kinect2_left_camera/hd/image_color_rect", Image, self.image_callback)

    def image_callback(self, data):
        namedWindow("Ref window")
        namedWindow("masked")
        namedWindow("canny")
